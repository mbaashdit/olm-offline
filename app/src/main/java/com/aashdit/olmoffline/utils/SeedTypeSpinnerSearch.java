...
public class SeedTypeSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
	...
	private SeedTypeSpinnerListener listener;
	private LimitExceedListener limitListener;

	private MyAdapter adapter;
	private List<SeedType> items;
	private boolean isSearchEnabled = true;

	public SeedTypeSpinnerSearch(Context context) {
		super(context);
	}

	public SeedTypeSpinnerSearch(Context arg0, AttributeSet arg1) {
		super(arg0, arg1);
	...
	public SeedTypeSpinnerSearch(Context arg0, AttributeSet arg1, int arg2) {
	...
	public List<SeedType> getSelectedItems() {
		List<SeedType> selectedItems = new ArrayList<>();
		for (SeedType item : items) {
			if (item.isSelected) {
	...
	public void onCancel(DialogInterface dialog) {
		...
		ArrayList<SeedType> selectedData = new ArrayList<>();
		for (int i = 0; i < items.size(); i++) {
			SeedType currentData = items.get(i);
	...
	public void setItems(List<SeedType> items, SeedTypeSpinnerListener listener) {
	...
	public interface LimitExceedListener {
		void onLimitListener(SeedType data);
	}

	//Adapter Class
	public class MyAdapter extends BaseAdapter implements Filterable {

		final List<SeedType> mOriginalValues; // Original Values
		final LayoutInflater inflater;
		List<SeedType> arrayList;

		MyAdapter(Context context, List<SeedType> arrayList) {
...
//            //Log.i(TAG, "getView() enter");
			...
			final SeedType data = arrayList.get(position);
		...
		public Filter getFilter() {
			return new Filter() {
				...
				protected void publishResults(CharSequence constraint, FilterResults results) {
					...
					arrayList = (List<SeedType>) results.values; // has the filtered values
				...
				protected FilterResults performFiltering(CharSequence constraint) {
					...
					List<SeedType> FilteredArrList = new ArrayList<>();
