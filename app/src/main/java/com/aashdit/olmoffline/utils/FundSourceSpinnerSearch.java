...
public class FundSourceSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    private FundSourceSpinnerListener listener;
    private LimitExceedListener limitListener;

    private MyAdapter adapter;
    private List<FundSource> items;
    private boolean isSearchEnabled = true;

    public FundSourceSpinnerSearch(Context context) {
        super(context);
    }

    public FundSourceSpinnerSearch(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public FundSourceSpinnerSearch(Context arg0, AttributeSet arg1, int arg2) {
    ...
    public List<FundSource> getSelectedItems() {
        List<FundSource> selectedItems = new ArrayList<>();
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayList<FundSource> selectedData = new ArrayList<>();
        for (int i = 0; i < items.size(); i++) {
            FundSource currentData = items.get(i);
    ...
    public void setItems(List<FundSource> items, FundSourceSpinnerListener listener) {
    ...
    public interface LimitExceedListener {
        void onLimitListener(FundSource data);
    }

    //Adapter Class
    public class MyAdapter extends BaseAdapter implements Filterable {

        final List<FundSource> mOriginalValues; // Original Values
        final LayoutInflater inflater;
        List<FundSource> arrayList;

        MyAdapter(Context context, List<FundSource> arrayList) {
...
//            //Log.i(TAG, "getView() enter");
            ...
            final FundSource data = arrayList.get(position);
        ...
        public Filter getFilter() {
            return new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    arrayList = (List<FundSource>) results.values; // has the filtered values
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    List<FundSource> FilteredArrList = new ArrayList<>();
