...
public class MonthSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Month> resultArrayList;
    private final LayoutInflater inflater;

    private final SharedPrefManager sp;

    public MonthSpnAdapter(Activity activity, List<Month> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Month currentItem = (Month) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Month currentItem) {
            itemName.setText(currentItem.getMonthName());
        }
    }
}
