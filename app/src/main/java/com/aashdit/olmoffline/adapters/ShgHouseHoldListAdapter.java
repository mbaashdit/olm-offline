...
public class ShgHouseHoldListAdapter extends RecyclerView.Adapter<ShgHouseHoldListAdapter.ProfilingViewHolder>{
    ...
    public ShgHouseHoldListAdapter(Context mContext, List<Entries> profilingList) {
    ...
    public void onBindViewHolder(@NonNull ProfilingViewHolder holder, int position) {
        ...
        holder.mCvActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activityDetailsListener.onActivityHHClick(position);
            }
        });
    ...
    ActivityHHDetailsListener activityDetailsListener;

    public void setActivityHhDetailsListener(ActivityHHDetailsListener activityDetailsListener) {
        this.activityDetailsListener = activityDetailsListener;
    }

    public  interface  ActivityHHDetailsListener{
        void onActivityHHClick(int position);
