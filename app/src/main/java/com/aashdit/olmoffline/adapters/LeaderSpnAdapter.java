...
public class LeaderSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Leader> resultArrayList;
    private final LayoutInflater inflater;

    public LeaderSpnAdapter(Activity activity, List<Leader> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Leader currentItem = (Leader) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Leader currentItem) {
