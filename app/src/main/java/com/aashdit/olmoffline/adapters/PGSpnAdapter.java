...
public class PGSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<PG> resultArrayList;
    private final LayoutInflater inflater;

    public PGSpnAdapter(Activity activity, List<PG> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PG currentItem = (PG) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(PG currentItem) {
