...
public class PendingOfflineItemsAdapter extends RealmRecyclerViewAdapter<TaskListItem,PendingOfflineItemsAdapter.ProfilingViewHolder>/* RecyclerView.Adapter<PendingOfflineItemsAdapter.ProfilingViewHolder>*/ {
    ...
    PendingOfflineDataListener pendingDataListener;
    private Long selectedActivity;
    private String userType;

    public PendingOfflineItemsAdapter(Context mContext, OrderedRealmCollection<TaskListItem> profilingList, Long type, String userType) {
...
//        holder.mTvPendingMbk.setText(approved.mbk);
        ...
        holder.mTvSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pendingDataListener.onSendForApproval(position,approved.unique,approved.activityName);
            }
        });
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pendingDataListener.onOfflinePendingClick(position);
            }
        });
    }
    ...
    public void setPendingDataListener(PendingOfflineDataListener pendingDataListener) {
        this.pendingDataListener = pendingDataListener;
    }

    public interface PendingOfflineDataListener {
        void onOfflinePendingClick(int position);
        void onSendForApproval(int position,String uniqueId,String actName);
    }
    ...
    public static class ProfilingViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProfilingViewHolder(@NonNull View itemView) {
            ...
            mTvSend = itemView.findViewById(R.id.cell_send);
