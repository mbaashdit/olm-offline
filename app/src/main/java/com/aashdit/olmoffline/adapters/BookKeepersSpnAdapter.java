...
public class BookKeepersSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<BookKeepers> resultArrayList;
    private final LayoutInflater inflater;

    public BookKeepersSpnAdapter(Activity activity, List<BookKeepers> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BookKeepers currentItem = (BookKeepers) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(BookKeepers currentItem) {
