...
public class PromotedBySpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Promotor> resultArrayList;
    private final LayoutInflater inflater;

    public PromotedBySpnAdapter(Activity activity, List<Promotor> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Promotor currentItem = (Promotor) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Promotor currentItem) {
