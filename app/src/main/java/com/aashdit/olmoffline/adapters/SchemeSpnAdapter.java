...
public class SchemeSpnAdapter extends BaseAdapter {
    ...
    public SchemeSpnAdapter(Activity activity, List<Schemes> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Schemes currentItem = (Schemes) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Schemes currentItem) {
            itemName.setText(currentItem.getSchemeNameEn());
        }
    }
}
