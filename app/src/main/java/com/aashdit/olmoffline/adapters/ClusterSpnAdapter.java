...
public class ClusterSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Cluster> resultArrayList;
    private final LayoutInflater inflater;

    public ClusterSpnAdapter(Activity activity, List<Cluster> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Cluster currentItem = (Cluster) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Cluster currentItem) {
