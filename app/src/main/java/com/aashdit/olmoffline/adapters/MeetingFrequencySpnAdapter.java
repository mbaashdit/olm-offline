...
public class MeetingFrequencySpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Frequency> resultArrayList;
    private final LayoutInflater inflater;

    public MeetingFrequencySpnAdapter(Activity activity, List<Frequency> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Frequency currentItem = (Frequency) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Frequency currentItem) {
