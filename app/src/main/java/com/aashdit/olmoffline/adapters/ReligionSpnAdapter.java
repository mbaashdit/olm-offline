...
public class ReligionSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Religion> resultArrayList;
    private final LayoutInflater inflater;

    public ReligionSpnAdapter(Activity activity, List<Religion> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Religion currentItem = (Religion) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Religion currentItem) {
