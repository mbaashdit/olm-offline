...
public class SkillSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Skill> resultArrayList;
    private final LayoutInflater inflater;

    public SkillSpnAdapter(Activity activity, List<Skill> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Skill currentItem = (Skill) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Skill currentItem) {
