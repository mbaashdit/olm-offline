...
public class GenderSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Gender> resultArrayList;
    private final LayoutInflater inflater;

    public GenderSpnAdapter(Activity activity, List<Gender> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Gender currentItem = (Gender) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Gender currentItem) {
