...
public class UOMSpnProdAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<UOM> resultArrayList;
    private final LayoutInflater inflater;

    public UOMSpnProdAdapter(Activity activity, List<UOM> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UOM currentItem = (UOM) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(UOM currentItem) {
