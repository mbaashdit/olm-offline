...
public class DisabilitySpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<Disability> resultArrayList;
    private final LayoutInflater inflater;

    public DisabilitySpnAdapter(Activity activity, List<Disability> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Disability currentItem = (Disability) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(Disability currentItem) {
