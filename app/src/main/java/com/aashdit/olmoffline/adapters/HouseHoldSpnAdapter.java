...
public class HouseHoldSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<HHEntity> resultArrayList;
    private final LayoutInflater inflater;

    public HouseHoldSpnAdapter(Activity activity, List<HHEntity> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HHEntity currentItem = (HHEntity) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(HHEntity currentItem) {
