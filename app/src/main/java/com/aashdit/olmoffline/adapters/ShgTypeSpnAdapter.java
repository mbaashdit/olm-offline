...
public class ShgTypeSpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<ShgType> resultArrayList;
    private final LayoutInflater inflater;

    public ShgTypeSpnAdapter(Activity activity, List<ShgType> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ShgType currentItem = (ShgType) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(ShgType currentItem) {
