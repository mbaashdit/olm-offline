...
public class ShgActivityListAdapter extends RecyclerView.Adapter<ShgActivityListAdapter.ProfilingViewHolder> {
    ...
    public ShgActivityListAdapter(Context mContext, List<Entries> profilingList) {
...
//        }
        ...
        holder.mCvActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activityDetailsListener.onActivityClick(position);
            }
        });
    ...
    ActivityDetailsListener activityDetailsListener;
