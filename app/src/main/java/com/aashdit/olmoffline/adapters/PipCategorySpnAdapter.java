...
public class PipCategorySpnAdapter extends BaseAdapter {

    private final Activity activity;
    private final List<PipCategory> resultArrayList;
    private final LayoutInflater inflater;

    public PipCategorySpnAdapter(Activity activity, List<PipCategory> resultArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PipCategory currentItem = (PipCategory) getItem(position);
    ...
    private class ViewHolder {
        ...
        public void bindData(PipCategory currentItem) {
